...
elem = viewer.AddComponent(trackBall);
...
% % elem.setCouleurPoints([1 0 0])
% % elem.setCouleurArretes([0 0 0])
% % elem.setCouleurFaces([0 1 1 0.4])
% % 
...
% % ens.setModelMatrix(MTrans3D([3 3 -3]) * MRot3D([0 45 0]));
            ...
            % elem=viewer.AddComponent(gysmoGeom,'ligne');
            ...
            elem = viewer.AddComponent(gysmoGeom);
            elem.AddColor(color);
