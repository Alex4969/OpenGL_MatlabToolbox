classdef Camera < handle
    ...
    methods % special transformations / gestion de la souris
        ...
        function rotate(obj, dx, dy)
            ...
            % [phi,theta,rayon]=cart2sph(pos(1),pos(2),pos(3)); %idem que les 3 lignes precedentes
            % theta = (pi/2-theta)   - dy * obj.sensibility;
            % phi   = phi  - dx * obj.sensibility;
