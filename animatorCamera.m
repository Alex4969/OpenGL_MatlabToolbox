classdef animatorCamera < animator 
    % camera animator
    ...
    methods
        % Constructor
        function obj = animatorCamera(camera_)
            % if nargin==1
            %     duration=2;
            % end
    ...
    methods
        ...
        function anim1(obj,N)
            ...
            for i=1:N
                obj.camera.position=obj.position+[1 0 0]*step;
                obj.camera.target=obj.target+[1 0 0]*step;
                % left=M(1,1:3,i);
                % up=M(2,1:3,i)
