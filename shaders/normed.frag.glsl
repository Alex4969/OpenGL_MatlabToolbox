...
void main()
{
    ...
    if (uLightData.x == 1.0){
        intensiteLumineuse = pointLight(vCrntPos, vNormal, uCamPos, uLightPos, uLightData.y, uLightData.z);
    } else if (uLightData.x == 2.0) {
        intensiteLumineuse = direcLight(vCrntPos, vNormal, uCamPos, uLightDir);
    } else if (uLightData.x == 3.0) {
        intensiteLumineuse = spotLight(vCrntPos, vNormal, uCamPos, uLightPos, uLightDir, uLightData.y, uLightData.z);
    }
